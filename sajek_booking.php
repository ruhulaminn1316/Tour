...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        // If email exists, insert data into the sajek_booking table
        $sql = "INSERT INTO sajek_booking (full_name, email, phone, package, preferred_date, special_requests)
        ...
        // If email does not exist, display a message and provide a button to go to the signup page
        echo "
        <html>
        <head>
        ...
        <body>
            ...
            <a href='signup.html' class='btn'>Go to Signup Page</a>
        </body>
        </html>";
    }
